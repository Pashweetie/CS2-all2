...
public class HW2{
	...
	public static LinkedClass<Borders> importBord(Borders border){
        LinkedClass<String> linesOfBords=new LinkedClass<String>();
        LinkedClass<Borders> bordering = new LinkedClass<Borders>();
    ...
    public static Borders returnBord(LinkedClass<Borders> jimbo, String a){
